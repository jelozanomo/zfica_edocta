sap.ui.define([
		...
		return BaseObject.extend("ean.edu.co.edo.cta.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias ean.edu.co.edo.cta.model.ListSelector
			 */
			 ...
			 * @return {ean.edu.co.edo.cta.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
